...
const (
	...
	AllowTeamApplicationsPolicyName = "steadystate-allow-team-applications"
	VersionLabelKey                 = "steadystate.dev/version"
	LogsLabelKey                    = "steadystate.dev/logs"
	TracesLabelKey                  = "steadystate.dev/traces"
	WorkloadKindLabelKey            = "steadystate.dev/workload-kind"
	RequireSignedImageLabelKey      = "steadystate.dev/require-signed-image"
	NetworkIsolationLabelKey        = "steadystate.dev/network-isolation"
