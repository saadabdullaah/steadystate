...
func TestVersionLockContainsRequiredPins(t *testing.T) {
	...
	for _, key := range []string{
		"GO_VERSION", "NODE_VERSION", "NODE_WINDOWS_AMD64_SHA256", "NODE_LINUX_AMD64_SHA256", "NODE_ALPINE_IMAGE", "KUBEBUILDER_VERSION", "KIND_VERSION", "KUBERNETES_VERSION",
		"KIND_NODE_IMAGE", "HELM_VERSION", "CALICO_VERSION", "ENVOY_GATEWAY_VERSION", "ENVOY_GATEWAY_IMAGE_SHA256", "ARGO_CD_VERSION",
