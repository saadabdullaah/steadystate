...
- Work remains on the single consolidated draft PR until local validation completes. Hosted run, artifact, merge, signed `v0.6.0` publication, generated GitOps PR, exact-main regression gates, tag, and release identifiers will be recorded only after they exist.
