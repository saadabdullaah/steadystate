...
> Status: Phases 0 through 6 are complete and released through [`v0.6.0`](https://github.com/saadabdullaah/steadystate/releases/tag/v0.6.0). Phase 7 implementation is complete in draft [PR #51](https://github.com/saadabdullaah/steadystate/pull/51) and remains gated on hosted SeaweedFS/Barman compatibility, signed `v0.7.0` delivery, exact-main disaster-recovery acceptance, and publication of `v0.7.0`.
